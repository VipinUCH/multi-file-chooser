...
//		populateImagesFromGallery();
	...
	public void btnChoosePhotosClick(View v){
		...
		Map<String, AppFiles> selectedItems = imageAdapter.getSelectedItems();

		if (selectedItems!= null && selectedItems.size() > 0) {
			Toast.makeText(getApplicationContext(), "Total photos selected: " + selectedItems.size(), Toast.LENGTH_SHORT).show();
...
//		imageAdapter = new MediaAdapter(this, imageUrls);
